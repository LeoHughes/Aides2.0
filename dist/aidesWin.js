...
/***/ function(module, exports, __webpack_require__) {
	...
	var util = new util_1.Util(), store = new store_1.Store();
	var AidesWin = (function (_super) {
	    __extends(AidesWin, _super);
	    function AidesWin() {
	        _super.call(this);
	        this.getUrlParam = util.getUrlParam;
	        this.getCookie = store.getCookie;
	        this.setCookie = store.setCookie;
	        this.clearCookie = store.clearCookie;
	        this.getStoreItem = store.getStoreItem;
	        this.setStoreItem = store.setStoreItem;
	        this.setStoreObj = store.setStoreObj;
	        this.getStoreObj = store.getStoreObj;
	        this.removeStoreItem = store.removeStoreItem;
	        this.clearStore = store.clearStore;
	    }
	    return AidesWin;
	}(aides_1.Aides));
	(function (window) {
